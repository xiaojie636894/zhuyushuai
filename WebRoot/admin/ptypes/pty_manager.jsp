...
<script type="text/javascript">
	var datatable = null;
				...
				language : {
    					...
    					serverSide:true,
    					ajax: {
		    						url:'${pageContext.request.contextPath}/admin/ptypes?op=manager',
		    						type:'POST',
		    						dataSrc : 'data',
    					...
    					columns:[
		    						...
		    						{data:'ptypeid',render:function(data,type,row){
		    							return "<a href='javascript:editPtype("+data+")'>修改</a><a href='javascript:delPtype("+data+")'> 删除</a> <a href='javascript:addPtype()'> 添加</a>";
		    						}},
    						]
					});
				}
		...
		bootbox.confirm({
			...
			callback : function(result) {
				if(result == true){
					$.ajax({
							type:"GET",
							url:"${pageContext.request.contextPath}/admin/ptypes?op=del",
							dataType:"text",
							data:{
									id:ptypeid
								},
...
<body>
	<form id="frmsearch">
		产品类别名称：<input id="proname" value="${requestScope.ptypename}" type="text" />
